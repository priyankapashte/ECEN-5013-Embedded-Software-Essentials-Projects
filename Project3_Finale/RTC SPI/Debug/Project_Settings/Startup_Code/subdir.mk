...
Project_Settings/Startup_Code/%.o: ../Project_Settings/Startup_Code/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -Dtimestamp=`(date +%s)` -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
